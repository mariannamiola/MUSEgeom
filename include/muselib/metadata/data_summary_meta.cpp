...
bool DataSummaryMeta::read(const std::string filename)
{
    return readConfFileJSON(filename);
}

bool DataSummaryMeta::write(const std::string filename)
{
    return writeConfFileJSON(filename);
}

bool DataSummaryMeta::readConfFileJSON(const std::string filename)
{
...
bool DataSummaryMeta::writeConfFileJSON (const std::string filename, const int &precision)
{
#ifdef MUSE_USES_CEREAL
