...
bool ComputeMeta::read(const std::string filename)
{
    return readConfFileJSON(filename);
}

bool ComputeMeta::write(const std::string filename)
{
    return writeConfFileJSON(filename);
}

bool ComputeMeta::readConfFileJSON(const std::string filename)
{
...
bool ComputeMeta::writeConfFileJSON (const std::string filename, const int &precision)
{
#ifdef MUSE_USES_CEREAL
