...
bool ExtractionMeta::read(const std::string filename)
{
    return readConfFileJSON(filename);
}

bool ExtractionMeta::write(const std::string filename)
{
    return writeConfFileJSON(filename);
}

bool ExtractionMeta::readConfFileJSON(const std::string filename)
{
...
bool ExtractionMeta::writeConfFileJSON (const std::string filename)
{
#ifdef MUSE_USES_CEREAL
