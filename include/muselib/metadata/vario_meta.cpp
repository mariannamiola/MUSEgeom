...
bool VarioMeta::read(const std::string filename)
{
    return readConfFileJSON(filename);
}

bool VarioMeta::write(const std::string filename)
{
    return writeConfFileJSON(filename);
}

bool VarioMeta::readConfFileJSON(const std::string filename)
{
...
bool VarioMeta::writeConfFileJSON (const std::string filename, const int &precision)
{
#ifdef MUSE_USES_CEREAL
